...
<div>
        ...
        <div class="container mt-5">
            <div class="row pt-5">
                <div class="col s12 center">
                    <h1 class="text-red title center-align">IEGŪSTI BALVAS<br><span class="white-text">GRIEZ</span></h1>
                </div>
            </div>
            <div class="row mt-mobile">
                <div class="col s12 main" v-lazy:background-image="cardsObj">
                    <img ref="wheel" data-src="img/wheel/wheel-lv.png" data-loading="img/wheel/wheel-blur.png" alt="" id="wheel" class="center-block wheel">
                    <img data-src="img/wheel/btn-lv.png" data-loading="img/wheel/btn-blur.png" alt="" class="wheel-btn">
        ...
        <div ref="modal" class="modal">
            ...
            <div v-if="(wheelId == 1 || wheelId == 2)">    
                <h4 class="title-modal">Jūsu bonuss</h4>
                <p class="text-modal">Katram jaunajam klientam <br>
                    pienākas savs bonuss.<br>
                    Jūs esiet ieguvis <span class="text-red">50 bezriska</span> griezienus <br>
                    WIXX spēlē
                </p>
            </div>
            <div v-if="(wheelId == 3)">    
                <h4 class="title-modal">Jūsu bonuss</h4>
                <p class="text-modal">
                    Jūs esiet ieguvis <span class="text-red">60 bezriska</span> griezienus <br>
                    WIXX spēlē (min. iemaksa 20 EUR)
                </p>
            </div>
            <div v-if="(wheelId == 4)">    
                <h4 class="title-modal">Jūsu bonuss</h4>
                <p class="text-modal">
                    Jūs esiet ieguvis <span class="text-red">75 bezriska</span> griezienus <br>
                    WIXX spēlē (min. iemaksa 20 EUR)
                </p>
            </div>
            <div v-if="(wheelId == 5)">    
                <h4 class="title-modal">Jūsu bonuss</h4>
                <p class="text-modal">
                    Jūs esiet ieguvis <span class="text-red">100 bezriska</span> griezienus <br>
                    WIXX spēlē (min. iemaksa 20 EUR)
                </p>
            </div>
            <div v-if="(wheelId == 6)">    
                <h4 class="title-modal">Jūsu bonuss</h4>
                <p class="text-modal">
                    Bezriska sporta <span class="text-red">likme 25 EUR vērtībā</span><br> (min. depozīts 25 EUR)
                </p>
            </div>
            ...
            <button v-if="(currentNum <3)" class="btn-modal" @click="modalClose">Griez vēlreiz!</button>
            <div class="modal-footer">
            <!-- <button class="btn-modal" @click.prevent="redirectUrl()">Saņem bonusu</button> -->
            <a class="btn-modal" :href="urlTo">Saņem bonusu</a>
            </div>
        </div>
        </div>
</template>
...
export default {
    ...
    mounted(){
        ...
        M.Modal.init(this.$refs.modal, {opacity: 0.8, dismissible:false});   
        // eslint-disable-next-line no-undef
        this.modal = M.Modal.getInstance(this.$refs.modal)
