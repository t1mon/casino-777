...
<div>
        ...
        <div class="container mt-5">
            <div class="row pt-5">
                <div class="col s12 center">
                    <h1 class="text-red title center-align">GET PRIZES<br><span class="white-text">SPIN</span></h1>
                </div>
            </div>
            <div class="row mt-mobile">
                <div class="col s12 main" v-lazy:background-image="cardsObj">
                    <img ref='wheel' data-src="img/wheel/wheel-en.png" data-loading="img/wheel/wheel-blur.png" alt="" id="wheel" class="center-block wheel">
                    <img data-src="img/wheel/btn-en.png" data-loading="img/wheel/btn-blur.png" alt="" class="wheel-btn">
        ...
        <div ref="modal_" class="modal">
            ...
            <div v-if="(wheelId == 1 || wheelId == 2)">    
                <h4 class="title-modal">check in</h4>
                <p class="text-modal">Each new customer is entitled <br>
                    to their own bonus!<br>
                    You have got<span class="text-red">50 risk free</span> spins <br>
                    at WIXX
                </p>
            </div>
            <div v-if="(wheelId == 3)">    
                <h4 class="title-modal">Your prize</h4>
                <p class="text-modal">
                    You have <span class="text-red">won 60 risk-free</span> spins <br>
                    in WIXX slot (min. deposit 20 EUR)
                </p>
            </div>
            <div v-if="(wheelId == 4)">    
                <h4 class="title-modal">Your prize</h4>
                <p class="text-modal">
                    You have <span class="text-red">won 75 risk-free</span> spins <br>
                    in WIXX slot (min. deposit 20 EUR)
                </p>
            </div>
            <div v-if="(wheelId == 5)">    
                <h4 class="title-modal">Your prize</h4>
                <p class="text-modal">
                    You have <span class="text-red">won 100 risk-free</span> spins <br>
                    in WIXX slot (min. deposit 20 EUR)
                </p>
            </div>
            <div v-if="(wheelId == 6)">    
                <h4 class="title-modal">Your prize</h4>
                <p class="text-modal">
                    Risk free <span class="text-red">sports bet 25 EUR</span><br> (min deposit 25 EUR)
                </p>
            </div>
            ...
            <button v-if="(currentNum <3)" class="btn-modal" @click="modalClose">Try again!</button>
            <div class="modal-footer">
            <a class="btn-modal" :href="urlTo">Claim your bonus</a>
            </div>
        </div>
        </div>
</template>
